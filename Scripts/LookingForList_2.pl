################################################################################################
## Minería de datos: Buscar lista de transcritos                                              ##
## Author: Olga Andrea Hernandez Miranda, Miranda H                                           ##
## Date: 05/09/2024                                                                           ##
## Este script permite buscar una lista de transcritos asociados a metabolismos hormonales    ##
## en una base de datos.                                                                      ##                                                                                    
################################################################################################
#!/usr/bin/perl -w
use strict;

my $reporte = "ListaEDsinD.txt";
open (FILE1, "$reporte");
my @Count1 = <FILE1>;
chomp @Count1;
